const styles = {
    ...
    button: 'w-[140px] h-[45px] sm:w-[160px] sm:h-[45px] md:w-[170px] md:h-[45px] lg:w-[180px] lg:h-[50px] bg-black my-3 flex items-center justify-center rounded-xl cursor-pointer',
