...
const Sponsored = () => {
  return (
    <div
      className={`${styles.section} hidden sm:block bg-white py-10 px-5 mb-12 coursor-pointer rounded-xl`}
    >
      <div className="flex justify-between w-full">
        ...
        <div className="flex items-start">
          <img
            src="https://static.vecteezy.com/system/resources/previews/054/650/815/non_2x/lg-logo-lg-electronics-logo-lg-transparent-logo-free-png.png"
            alt="SponsoredImage"
            style={{ width: "150px",height:"80px", objectFit: "contain" }}
          />
        </div>
        <div className="flex items-start">
          <img
            src="https://media.licdn.com/dms/image/v2/D4D12AQHwi4jdRd3fQQ/article-cover_image-shrink_600_2000/article-cover_image-shrink_600_2000/0/1685279753620?e=2147483647&v=beta&t=YW7XR2IH5YitaLgvCDlC6rEOqSRzpVzgZ4BWONafvuU"
            alt="SponsoredImage"
            style={{ width: "150px",height:"80px", objectFit: "contain" }}
          />
        </div>
