            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <div className="mt-2 flex items-center">
                  ...
                  <label
                    htmlFor="file-input"
                    className="ml-5 flex items-center justify-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-black hover:text-white bg-white hover:bg-[#077f9c]"
                  >
              ...
              <div className={`${styles.normalFlex} w-full`}>
                ...
                <Link to="/shop-login" className="text-[#077f9c] pl-2">
                  Sign In
                </Link>
              </div>
            </form>
